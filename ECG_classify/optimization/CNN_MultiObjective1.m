...
clc;
M=5;
accuracy=[0.9152,0.9569,0.9663,0.9708,0.9695];
...
subplot(3,3,1);plot(L_1);xlabel('(a)q');ylabel('O');           
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2; 
clear C; clear error; clear accuracy;
...
subplot(3,3,2);plot(L_2);      xlabel('(a)q');ylabel('O');
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2;
clear C; clear error; clear accuracy;
...
subplot(3,3,4);plot(L_3);      xlabel('(a)q');ylabel('O');
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2;
clear C; clear error; clear accuracy;
...
subplot(3,3,5);plot(L_4);      xlabel('(a)q');ylabel('O');
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2;
clear C; clear error; clear accuracy;
...
subplot(3,3,7);plot(L_5);      xlabel('(a)q');ylabel('O');
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2; 
clear C; clear error; clear accuracy;
...
subplot(3,3,8);plot(L_6);      xlabel('(a)q');ylabel('O');
clear eta1;clear eta2;
clear DeltaC;clear DeltaA;
clear L1;clear L2; 